...
import com.ehsanrc.boipoka.adapters.ReadingAdapter;
...
public class Reading extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView readingList = (ListView) findViewById(R.id.list_reading);
...
//        int pos=books.get(index).getId();
        ...
        switch(item.getItemId()) {
            case CONTEXT_MENU_ABOUT: {
                ...
                Intent intent = new Intent(Reading.this,BookInfo.class);
