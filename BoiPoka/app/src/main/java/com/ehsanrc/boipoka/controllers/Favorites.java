...
import com.ehsanrc.boipoka.adapters.FavoritesAdapter;
...
public class Favorites extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView bookList = (ListView) findViewById(R.id.lv_favorites);
        ...
        FavoritesAdapter adapter = new FavoritesAdapter(this,books);
        bookList.setAdapter(adapter);

        bookList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(Favorites.this, Chapters.class);
...
//        int pos=books.get(index).getId();
        ...
        switch(item.getItemId()) {
            case CONTEXT_MENU_ABOUT: {
                ...
                Intent intent = new Intent(Favorites.this,BookInfo.class);
